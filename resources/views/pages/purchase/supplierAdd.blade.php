                ...
                <div class="w-full">
                    ...
                    <form action="#">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="w-full">
                                <label for="price"
                                    class="block mb-3 text-14 font-medium text-gray-900 dark:text-white">Email</label>
                                <input type="text" name="price" id="price"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-zinc-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div class="w-full">
                                <label for="price"
                                    class="block mb-3 text-14 font-medium text-gray-900 dark:text-white">Phone
                                    Number</label>
                            ...
                            <div>
                                <label for="country"
                                    class="block mb-3 text-14 font-medium text-gray-900 dark:text-white">Negara</label>
                            ...
                            <div>
                                <label for="province"
                                    class="block mb-3 text-14 font-medium text-gray-900 dark:text-white">Provinsi</label>
                            ...
                            <div>
                                <label for="city"
                                    class="block mb-3 text-14 font-medium text-gray-900 dark:text-white">Kota</label>
                            ...
                            <div>
                                <label for="district"
                                    class="block mb-3 text-14 font-medium text-gray-900 dark:text-white">Kabupaten</label>
                            ...
                            <div>
                                <label for="postal_code"
                                    class="block mb-3 text-14 font-medium text-gray-900 dark:text-white">Kode
                                    Pos</label>
                            ...
                            <div>
                                <label for="address_detail"
                                    class="block mb-3 text-14 font-medium text-gray-900 dark:text-white">Detail
                                    Alamat</label>
