<x-layouts::app :title="__('Faktur Belum Selesai')">
    <div class="flex flex-col gap-6 w-full">
        <x-layouts::page-header title="Faktur Belum Selesai"
            ...
            <x-slot:breadcrumbs>
                ...
                <li class="flex items-center gap-1.5 text-sm font-medium"><span>/</span><span>Faktur Belum Selesai</span></li>
            </x-slot:breadcrumbs>
