<x-layouts::app :title="__('Purchase Invoice')">
    <div class="flex flex-col items-center justify-between min-h-full gap-6">
        {{-- content --}}
        <div class="flex flex-col gap-6 w-full">
            {{-- header --}}
            <x-layouts::page-header :title="__('Purchase Invoice')"
                ...
                <x-slot:breadcrumbs>
                    ...
                    <li aria-current="page">
                        <div class="flex items-center space-x-1.5">
                            ...
                            <span class="inline-flex items-center text-base font-medium">Purchase Invoice</span>
                        </div>
                    </li>
                </x-slot:breadcrumbs>

                <x-slot:actions>
                    <a href="{{ route('purchases.transaction.purchase-invoice-add') }}"
                        :current="request()->routeIs('purchases.transaction.purchase-invoice-add')" wire:navigate
            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <p class="font-semibold text-white text-xl">Data Tabel Purchase Invoice</p>
                            ...
                            <form class="flex items-center w-full">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="simple-search"
                                        class="bg-zinc-800 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full md:w-xl pl-10 p-3 dark:bg-zinc-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <table class="w-full text-md text-left text-gray-500 dark:text-gray-400 mt-4">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-4">Purchase Invoice No</th>
                                    <th scope="col" class="px-4 py-4">Date</th>
                                    <th scope="col" class="px-4 py-4">Supplier</th>
                                    <th scope="col" class="px-4 py-4">Total Nett</th>
                            ...
                            <tbody class="dark:bg-zinc-950">
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">Rp 5.250.000</td>
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-blue-100 text-blue-800 text-base font-medium px-2.5 py-0.5 rounded dark:bg-blue-600 dark:text-white">Proceed</span>
                                    </td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">Rp 3.750.000</td>
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-yellow-100 text-yellow-800 text-base font-medium px-2 py-0.5 rounded dark:bg-yellow-600 dark:text-white">Partial
                                            Paid</span>
                                    </td>
                                    <td class="px-4 py-4 flex items-center justify-start">
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-purple-100 text-purple-800 text-base font-medium px-2 py-0.5 rounded dark:bg-purple-600 dark:text-white">Paid</span>
                                    </td>
                                    <td class="px-4 py-4 flex items-center justify-start">
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">Rp 2.100.000</td>
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-blue-100 text-blue-800 text-base font-medium px-2 py-0.5 rounded dark:bg-blue-600 dark:text-white">Proceed</span>
                                    </td>
                                    <td class="px-4 py-4 flex items-center justify-start">
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">Rp 6.300.000</td>
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-green-100 text-green-800 text-base font-medium px-2 py-0.5 rounded dark:bg-green-600 dark:text-white">Confirm</span>
                                    </td>
                                    <td class="px-4 py-4 flex items-center justify-start">
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">Rp 4.800.000</td>
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-green-100 text-green-800 text-base font-medium px-2 py-0.5 rounded dark:bg-green-600 dark:text-white">Confirm</span>
                                    </td>
