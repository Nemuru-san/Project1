<x-layouts::app :title="__('Purchase Invoice Add')">
    <div class="flex flex-col items-center justify-between min-h-full gap-6 w-full">
                ...
                <x-slot:breadcrumbs>
                    ...
                    <li aria-current="page">
                        <div class="flex items-center space-x-1.5">
                            ...
                            <span class="inline-flex items-center text-sm font-medium">Purchase Invoice</span>
                        </div>
                    </li>
                </x-slot:breadcrumbs>
        ...
        <div
            ...
            <div class="w-full">
                <h2 class="mb-6 text-xl font-bold text-gray-900 dark:text-white">Buat Purchase Invoice Baru
                </h2>
                <form action="#">
                    <div class="grid gap-5 sm:grid-cols-2 sm:gap-x-12 sm:gap-y-6">
                        ...
                        <div class="w-full">
                            <label for="supplier"
                                class="block mb-3 text-lg font-medium text-gray-900 dark:text-white">Term of
                                Payment</label>
                            <select id="supplier" name="supplier"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-md focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-zinc-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                required="">
                                <option value="">-- Pilih Term of Payment No --</option>
                        ...
                        <table class="w-full text-base text-left text-gray-900 dark:text-white my-2">
                            ...
                            <tbody>
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-001</td>
                                    <td class="px-4 py-3">GR-001</td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-002</td>
                                    <td class="px-4 py-3">GR-002</td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-003</td>
                                    <td class="px-4 py-3">GR-003</td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-004</td>
                                    <td class="px-4 py-3">GR-004</td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-005</td>
                                    <td class="px-4 py-3">GR-005</td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-006</td>
                                    <td class="px-4 py-3">GR-006</td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-007</td>
                                    <td class="px-4 py-3">GR-007</td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-008</td>
                                    <td class="px-4 py-3">GR-008</td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-009</td>
                                    <td class="px-4 py-3">GR-009</td>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">PO-010</td>
                                    <td class="px-4 py-3">GR-010</td>
        ...
        <div
            ...
            <div class="flex flex-col sm:flex-row items-center justify-end gap-4 w-full">
                ...
                <button type="button" onclick="location.href='{{ Route('purchases.transaction.purchase-invoice') }}'"
