            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <p class="font-semibold text-white text-xl">Data Tabel Purchase Order</p>
                        ...
                        <table class="w-full text-md text-left text-gray-500 dark:text-gray-400 mt-4">
                            ...
                            <tbody class="dark:bg-zinc-950">
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-yellow-100 text-yellow-800 text-base font-medium px-2.5 py-0.5 rounded dark:bg-yellow-600 dark:text-white">Invoice</span>
                                    </td>
                                    <td class="px-4 py-4 flex items-center justify-start">
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-red-100 text-red-800 text-base font-medium px-2.5 py-0.5 rounded dark:bg-red-600 dark:text-white">Canceled</span>
                                    </td>
                                    <td class="px-4 py-4 flex items-center justify-start">
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-green-100 text-green-800 text-base font-medium px-2.5 py-0.5 rounded dark:bg-green-600 dark:text-white">Confirmed</span>
                                    </td>
                                    <td class="px-4 py-4 flex items-center justify-start">
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-zinc-800">
                                    ...
                                    <td class="px-4 py-4">
                                        <span
                                            class="bg-purple-100 text-purple-800 text-base font-medium px-2.5 py-0.5 rounded dark:bg-purple-600 dark:text-white">Receive</span>
                                    </td>
                                    <td class="px-4 py-4 flex items-center justify-start">
