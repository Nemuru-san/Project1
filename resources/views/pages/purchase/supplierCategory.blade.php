<x-layouts::app :title="__('Supplier Categories')">
    ...
    <div class="container flex flex-col items-center justify-between min-h-full gap-6">
        ...
        <div class="flex flex-col gap-6 w-full">
            ...
            {{-- content --}}
            <div
                class="w-full h-full overflow-hidden rounded-md border border-neutral-200 dark:border-neutral-700 p-4 items-center justify-between gap-4">
        ...
        {{-- footer --}}
        <div
            class="grid grid-cols-1 w-full overflow-hidden rounded-md border border-neutral-200 dark:border-neutral-700 p-4 gap-4">
