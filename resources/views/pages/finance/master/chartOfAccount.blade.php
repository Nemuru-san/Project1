<x-layouts::app :title="__('Daftar Akun')">
    ...
    <div class="flex flex-col items-center justify-between min-h-full gap-6 w-full">
        <div class="flex flex-col gap-6 w-full">
            ...
            {{-- header --}}
            <x-layouts::page-header :title="__('Daftar Akun')"
                ...
                <x-slot:breadcrumbs>
                    ...
                    <li aria-current="page">
                        <div class="flex items-center space-x-1.5">
                            ...
                            <span class="inline-flex items-center text-sm font-medium">Daftar Akun</span>
                        </div>
                    </li>
                </x-slot:breadcrumbs>
            ...
            <div
                ...
                <livewire:finance.master.chart-of-account />
            </div>
        </div>
    </div>
