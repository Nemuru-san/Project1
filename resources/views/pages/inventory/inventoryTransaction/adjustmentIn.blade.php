<x-layouts::app :title="__('Penyesuaian Stok Masuk')">

      <div class="flex flex-col items-center justify-between min-h-full gap-6 w-full">
            <div class="flex flex-col gap-6 w-full">
            {{-- header --}}
            <x-layouts::page-header :title="__('Penyesuaian Stok Masuk')"
                  ...
                  <x-slot:breadcrumbs>
                        ...
                        <li aria-current="page">
                              ...
                              <span class="inline-flex items-center text-sm font-medium">Penyesuaian Stok Masuk</span>
                              </div>
                        </li>
                  </x-slot:breadcrumbs>
                  ...
                  <livewire:inventory.inventory-transaction.adjustment-in />
                  </div>
            </div>
      </div>
