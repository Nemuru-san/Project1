<x-layouts::app :title="__('Penyesuaian Stok Keluar')">

      <div class="flex flex-col items-center justify-between min-h-full gap-6 w-full">
            <div class="flex flex-col gap-6 w-full">
                  {{-- header --}}
                  <x-layouts::page-header :title="__('Penyesuaian Stok Keluar')"
                  ...
                  <livewire:inventory.inventory-transaction.adjustment-out />
                  </div>
            </div>
      </div>
