...
<div class="flex flex-col items-center justify-between min-h-full gap-6 w-full">
            <div class="flex flex-col gap-6 w-full">
                  {{-- header --}}
            <x-layouts::page-header :title="__('Product Master')"
                  ...
                  <x-slot:breadcrumbs>
                        ...
                        <li aria-current="page">
                              ...
                              <span class="inline-flex items-center text-sm font-medium">Product Master</span>
                              </div>
                        </li>
                  </x-slot:breadcrumbs>
            ...
            {{-- content --}}
            <div class="w-full h-full overflow-hidden rounded-md dark:border bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 p-4">
                  <livewire:inventory.master-product.product-master /></div>
            </div>
</div>
