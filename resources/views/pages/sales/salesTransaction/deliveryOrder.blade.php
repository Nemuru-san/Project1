            ...
            <div class="flex flex-col gap-6 w-full">
                  ...
                  <x-slot:breadcrumbs>
                        ...
                        <li aria-current="page">
                              ...
                              <span class="inline-flex items-center text-sm font-medium">Delivery Order</span>
                              </div>
                        </li>
                  </x-slot:breadcrumbs>
