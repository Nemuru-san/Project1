<x-layouts::app :title="__('Customer Delivery Address')">

      <div class="flex flex-col items-center justify-between min-h-full gap-6 w-full">
            <div class="flex flex-col gap-6 w-full">
                  {{-- header --}}
                  <x-layouts::page-header :title="__('Customer Delivery Address')" :
                  ...
                  <x-slot:breadcrumbs>
                        ...
                        <li aria-current="page">
                              ...
                              <span class="inline-flex items-center text-sm font-medium">Customer Delivery Address</span>
                              </div>
                        </li>
                  </x-slot:breadcrumbs>
            ...
            <div
                  ...
                  <livewire:sales.sales-master.customer-delivery-address />
                  </div>
            </div>
      </div>
