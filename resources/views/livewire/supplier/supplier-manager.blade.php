<div x-data="{ toastMsg: '', toastType: '' }"
    ...
    <x-filter.card title="Filter Supplier" description="Temukan supplier berdasarkan kode, nama, atau kontak.">
        <x-slot:actions>
            <x-filter.add-button wire:click="openCreate">Tambah Pemasok</x-filter.add-button>
        </x-slot:actions>
        <x-filter.search placeholder="Cari kode, nama, kontak..." />
