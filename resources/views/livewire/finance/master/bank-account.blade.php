<div x-data="{ toastMsg: '', toastType: '' }"
    ...
    <x-filter.card title="Filter Bank / Cash" description="Temukan rekening berdasarkan nama, bank, atau nomor rekening.">
        <x-slot:actions>
            <x-filter.add-button wire:click="openCreate">Tambah Bank / Cash</x-filter.add-button>
        </x-slot:actions>
        <x-filter.search placeholder="Cari nama, bank, nomor rekening..." />
