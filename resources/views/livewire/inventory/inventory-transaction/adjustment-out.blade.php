                    ...
                    <tr
                        ...
                        <td class="px-4 py-4">
                            ...
                            @elseif ($adjustment->status === 'draft')
                                <span
                                    class="text-sm font-normal px-2.5 py-0.5 rounded bg-gray-600 text-white">Draf</span>
        ...
        <div class="fixed inset-0 z-40 flex items-start justify-center overflow-hidden bg-black/50 backdrop-blur-sm p-4">
            <div
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold dark:text-white">Penyesuaian Stok Keluar
                    </h3>
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-xl w-full max-w-sm mx-4 p-6">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-base font-semibold dark:text-white">
                        Setujui Penyesuaian Stok Keluar?
                    </h3>
                </div>

                <p class="text-sm text-gray-500 dark:text-gray-400 mb-5">
                    Setelah Penyesuaian Stok Keluar disetujui, stok produk akan berkurang dari warehouse yang dipilih.
        ...
        <div class="fixed inset-0 z-50 flex items-start justify-center overflow-hidden bg-black/60 backdrop-blur-sm p-4">
            <div
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b dark:border-zinc-700">
                    <div>
                        <h2 class="text-xl font-bold text-gray-800 dark:text-white">Detail Penyesuaian Stok Keluar</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="text-gray-800 dark:text-white">Penyesuaian Stok Keluar</span>
                            </div>
    ...
    @if ($showDeleteModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md p-6">
                <h3 class="text-lg font-semibold dark:text-white">Hapus Penyesuaian Stok Keluar?</h3>

                <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">
                    Data Penyesuaian Stok Keluar akan dipindahkan ke tempat sampah.
                </p>
