<div x-data="{ toastMsg: '', toastType: '' }"
    ...
    <x-filter.card title="Filter Gudang" description="Temukan gudang berdasarkan kode atau nama.">
        <x-slot:actions>
            <x-filter.add-button wire:click="openCreate">Tambah Gudang</x-filter.add-button>
        </x-slot:actions>
        <x-filter.search placeholder="Cari gudang..." />
