    ...
    @if ($showModal)
        <div class="fixed inset-0 z-40 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl w-full max-w-lg mx-auto max-h-[80vh] flex flex-col overflow-hidden">
                <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl w-full max-w-full mx-auto flex flex-col overflow-hidden"
                    ...
                    <div class="flex-1 overflow-y-auto px-6 py-5">
                        <div class="flex flex-col gap-4">
                            <div class="w-full">
                                <label for="wh_code" class="block mb-3 text-base font-medium text-gray-900 dark:text-white">WH Code</label>
                                <input type="text" id="wh_code" name="wh_code" wire:model="wh_code"
                            ...
                            <div class="w-full">
                                <label for="wh_desc" class="block mb-3 text-base font-medium text-gray-900 dark:text-white">WH Desc</label>
                                <input type="text" id="wh_desc" name="wh_desc" wire:model="wh_desc"
