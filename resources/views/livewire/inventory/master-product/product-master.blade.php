<div x-data="{
    ...
    <x-filter.card title="Filter Produk" description="Temukan produk berdasarkan SKU, nama, atau barcode.">
        <x-slot:actions>
            <x-filter.add-button wire:click="openCreate">Tambah Produk</x-filter.add-button>
        </x-slot:actions>
        <x-filter.search placeholder="Cari SKU, nama, barcode..." />
