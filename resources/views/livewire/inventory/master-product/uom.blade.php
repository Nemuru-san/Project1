<div x-data="{ toastMsg: '', toastType: '' }"
    ...
    <x-filter.card title="Filter Satuan" description="Temukan satuan berdasarkan kode atau nama.">
        <x-slot:actions>
            <x-filter.add-button wire:click="openCreate">Tambah Satuan</x-filter.add-button>
        </x-slot:actions>
        <x-filter.search placeholder="Cari kode, nama..." />
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl w-full max-w-lg mx-auto max-h-[min(80vh,calc(100dvh-2rem))] flex flex-col overflow-hidden"
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold dark:text-white">
                        {{ $editingId ? 'Edit' : 'Tambah' }} Unit of Measure
                    </h3>
