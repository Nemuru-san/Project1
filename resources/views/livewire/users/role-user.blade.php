<div x-data="{ toastMsg: '', toastType: '' }"
    ...
    <x-filter.card title="Filter Peran Pengguna" description="Temukan peran berdasarkan nama.">
        <x-slot:actions>
            <x-filter.add-button wire:click="openCreate">Tambah Peran</x-filter.add-button>
        </x-slot:actions>
        <x-filter.search placeholder="Cari role..." />
