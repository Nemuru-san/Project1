<div>
    ...
    <div class="mt-5 flex flex-col gap-4">
        <div>
            <h2 class="text-base font-semibold text-gray-900 dark:text-white">Faktur Penjualan Belum Lunas</h2>
            <p class="text-sm text-gray-500">Faktur terkonfirmasi dengan sisa tagihan lebih dari nol.</p>
        </div>
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-6"><input wire:model.live.debounce.300ms="search"
                type="search" placeholder="Cari faktur / SO / pelanggan"
