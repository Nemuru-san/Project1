<div x-data="{ toastMsg: '', toastType: '' }"
    ...
    <div
        ...
        <p class="dark:text-white text-base font-semibold">Data Tabel Customer Delivery Address</p>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                            <div class="lg:col-span-2">
                                <label class="block mb-1 text-sm font-medium dark:text-white">Customer</label>
                            ...
                            <div>
                                <label class="block mb-1 text-sm font-medium dark:text-white">Customer Delivery Address Code</label>
                                <input type="text" name="customer_code" id="customer_code"
                                    ...
                                    placeholder="Masukkan customer delivery address code">
                            </div>

                            <div>
                                <label class="block mb-1 text-sm font-medium dark:text-white">Customer Delivery Address</label>
                                <input type="text" name="customer_name" id="customer_name"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-zinc-800 dark:border-gray-600 dark:text-white"
                                    placeholder="Masukkan customer delivery address">
                            </div>
                        </div>
