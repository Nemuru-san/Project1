                            ...
                            <table class="w-full min-w-max border-collapse text-left text-sm text-gray-700 dark:text-gray-200">
                                <thead class="bg-gray-100 text-xs font-bold uppercase text-gray-700 dark:bg-zinc-700 dark:text-white">
                                    <tr>
                                        ...
                                        <th class="whitespace-nowrap border border-gray-300 px-4 py-3 text-right dark:border-zinc-600">Qty Outstanding</th>
                                ...
                                <tbody class="bg-white dark:bg-zinc-900">
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800">
                                        ...
                                        <td class="border border-gray-300 px-4 py-3 text-right dark:border-zinc-600">30</td>
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800">
                                        ...
                                        <td class="border border-gray-300 px-4 py-3 text-right dark:border-zinc-600">12</td>
