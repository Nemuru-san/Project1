                ...
                @forelse($deliveryOrders as $deliveryOrder)
                    <tr wire:key="surat-jalan-{{ $deliveryOrder->id }}" class="hover:bg-gray-50 dark:hover:bg-zinc-800">
                        ...
                        <td class="px-4 py-3">
                            ...
                            @elseif($deliveryOrder->status === \App\Models\DeliveryOrder::STATUS_INVOICED)
                                <span
                                    class="rounded-full bg-blue-100 px-2.5 py-1 text-xs text-blue-700">Difakturkan</span>
                            @else
