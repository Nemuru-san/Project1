            ...
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-zinc-700 dark:bg-zinc-900">
                @forelse ($salesOrders as $order)
                    <tr wire:key="sales-order-{{ $order->id }}" class="hover:bg-gray-50 dark:hover:bg-zinc-800 {{ $order->trashed() ? 'opacity-60' : '' }}">
                        ...
                        <td class="px-4 py-3">@if($order->trashed())<span class="rounded-full bg-red-100 px-2.5 py-1 text-xs text-red-700 dark:bg-red-900/40 dark:text-red-300">Terhapus</span>@else<span class="rounded-full bg-yellow-100 px-2.5 py-1 text-xs text-yellow-700 dark:bg-yellow-900/40 dark:text-yellow-300">Draf</span>@endif</td>
                        <td class="px-4 py-3">
                        ...
                        <div class="mt-12">
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full min-w-max border-collapse border border-gray-300 text-left text-sm dark:border-zinc-600 dark:text-white">
                                    <thead class="bg-gray-200 text-xs font-bold uppercase dark:bg-zinc-700"><tr><th class="w-14 border border-gray-300 px-4 py-3 text-center dark:border-zinc-600"><button wire:click="openProductPicker" type="button" class="inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-sm bg-blue-600 text-xl text-white hover:bg-blue-700">+</button></th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">No.</th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">Kode</th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">Produk</th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">Gudang</th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">Satuan</th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">Sisa Stok</th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">Qty</th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">Harga</th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">Diskon</th><th class="border border-gray-300 px-4 py-3 dark:border-zinc-600">Subtotal</th></tr></thead>
                                    <tbody>
                                        @forelse($items as $index => $item)
                                            <tr wire:key="so-item-{{ $item['product_id'] }}" class="hover:bg-gray-100 dark:hover:bg-zinc-800">
                                                ...
                                                <td class="border border-gray-300 px-4 py-3 dark:border-zinc-600"><span class="rounded bg-blue-100 px-2.5 py-1 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300">{{ number_format($item['stock_available'], 0, ',', '.') }} {{ $item['base_unit_name'] }}</span></td>
