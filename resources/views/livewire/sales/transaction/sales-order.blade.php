...
<div class="fixed inset-0 z-40 flex items-center justify-center overflow-hidden bg-black/50 p-4 backdrop-blur-sm">
    <div class="mx-auto flex w-full max-w-full h-[85vh] max-h-[750px] flex-col overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-zinc-800"
        x-data="{}">
        <div class="flex shrink-0 items-center justify-between border-b border-gray-200 bg-zinc-50 px-8 py-6 dark:border-zinc-700 dark:bg-zinc-900">
            <h3 class="text-lg font-semibold dark:text-white">Sales Order</h3>
        ...
        <div class="min-h-0 flex-1 touch-pan-y overflow-y-auto px-4 py-4 sm:px-6 sm:py-5 lg:px-8 lg:py-6"
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    <label class="mb-1 block text-sm font-medium dark:text-white">Order No</label>
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium dark:text-white">Reff Sales Canvasing</label>
                    <select class="w-full rounded-lg border border-gray-300 p-2.5 text-sm dark:border-gray-600 dark:bg-zinc-700 dark:text-white">
                        <option value="">Pilih Reff Sales Canvasing</option>
                        <option value="CAN-001">CAN-001 - PT. ABC (2026-07-19)</option>
                        <option value="CAN-002">CAN-002 - PT. XYZ (2026-07-20)</option>
                    </select>
                </div>

                <div>
                    <label class="mb-1 block text-sm font-medium dark:text-white">Reff Sales Pre Order</label>
                    <select class="w-full rounded-lg border border-gray-300 p-2.5 text-sm dark:border-gray-600 dark:bg-zinc-700 dark:text-white">
                        <option value="">Pilih Reff Sales Pre Order</option>
                        <option value="PRE-001">PRE-001 - PT. ABC (2026-07-19)</option>
                        <option value="PRE-002">PRE-002 - PT. XYZ (2026-07-20)</option>
                    </select>
                </div>

                <div>
                    <label class="mb-1 block text-sm font-medium dark:text-white">Term of Payment</label>
                    <select class="w-full rounded-lg border border-gray-300 p-2.5 text-sm dark:border-gray-600 dark:bg-zinc-700 dark:text-white">
