<div x-data="{ toastMsg: '', toastType: '' }"
    ...
    <x-filter.card title="Filter Faktur Retur Penjualan" description="Temukan faktur retur berdasarkan kata kunci, status, atau rentang tanggal.">
        <x-slot:actions>
            <x-filter.add-button wire:click="openCreate">Tambah Faktur Retur</x-filter.add-button>
        </x-slot:actions>
        <x-filter.search placeholder="Cari faktur retur / pelanggan" />
